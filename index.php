...
<body>
    ...
    <form method="POST" action="functions/shorten.php">
        ...
        <img src="./assets/images/warrow.svg" class="warrow ignore">
    </form>
    <div class="infodiv">
        <img src="./assets/images/warning.svg" class="ignore">
        <p class="bold ignore" style="font-size:16px; margin-left:35px; margin-top:-25px; color:#333333;">이런 사이트는 링크를 단축할 수 없어요!</p>
    </div>
