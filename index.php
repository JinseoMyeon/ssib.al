...
<body>
    ...
    <div class="infodiv">
        ...
        <p class="bold ignore" style="position: relative; font-size:1rem; margin-left:2rem; margin-top: -1.6rem; color:#333333;">이런 사이트는 링크를 단축할 수 없어요.</p>
        <p class="ignore paragraph m-2">대한민국 법률 상 <strong>불법, 유해 사이트</strong>로 지정된 사이트</p>
        <p class="ignore paragraph m-1" style="margin-top: 1vh;">해킹, 스미싱 등 <strong>불법적인 용도</strong>로 사용하는 사이트</p>
        <p class="ignore paragraph m-1" style="margin-top: 1vh;"><strong>상업적인 용도</strong>로 사용하는 사이트</p>
        <p class="ignore paragraph m-05" style="margin-top: 0.5vh; font-size: 0.75rem; color: #CDCDCD; font-weight: 400;">(설마 이 링크로...?)</p>
        <p class="ignore paragraph m-1" style="margin-top: 1vh;">이외 운영자가 <strong>링크 단축 서비스를 제공할 수 없다</strong>고 판단하는 사이트</p>
        <p class="ignore paragraph m-05" style="margin-top: 0.5vh; font-size: 0.75rem; color: #CDCDCD; font-weight: 400;">이런 사이트는 운영자에 의해 무통보 삭제될 수 있어요.</p>
        <p class="ignore paragraph m-2" style="margin-top: 2vh; font-size: 0.75rem;">이 사이트는 <strong>링크 단축 서비스만</strong> 제공하고 있습니다.<br>
            이 서비스의 운영자는 해당 링크 단축 서비스를 이용해 발생하는 어떠한 사건에도 <strong>책임을 지지 않습니다.</strong></p>
    </div>
