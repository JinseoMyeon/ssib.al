...
<body>
    ...
    <div class="banner">
        <div class="bannerContent">
            <p class="bannerText">ssib.al의 <strong class="blue">공식 디스코드 서버</strong>가 생겼어요! <a href="https://ssib.al/discord"><strong class="blue">ssib.al/discord</strong></a>에서 소통하실 수 있어요!</p>
        </div>
    </div>
    ...
    <div class="githubdiv" onclick='location.href="https://github.com/jinseomyeon/ssib.al"'>
