...
<?php
    if (isset($_SESSION['success'])) {
        ...
        echo "<div id='shortenResult' onclick='copy()'>
    ...
    if (isset($_SESSION['error'])) {
        ...
        <p id='resultLinkSuccess'>링크를 줄이는 데 실패했어요.</p>"
        . $_SESSION['error'] .
        "</div>";
    ...
    ?>
    <div id="restrictionInfo" onclick="restrictionClose()"></div>
    <div id="restrictionBackground">
        ...
        <button id="restClose" name="restClose" onclick="restrictionClose()">
            <p id="restText">확인 완료</p>
        </button>
    </div>
    <div id="header">
        <div id="logo">
            <a href="index.html"><img src="assets/image/logo.svg" class="logo" alt="logo"></a>
        </div>
    </div>
    <div id="wrapper">
        <div id="scrollSection">
                ...
                <div id="content">
                    ...
                    <div id="userInput">
                        <form method="POST" action="functions/shorten.php">
                            <div id="originalURL">
                                <input type="link" name="input" id="input" class="draggable" value="https://" placeholder="줄이고 싶은 링크를 입력해주세요.">
                            </div>
                            <div id="shortenURL">
                                <div id="uniqueCode">
                                ...
                                <div id="submit">
                                    <input type="submit" class="submit" value="링크 줄이기">
                                </div>
                            </div>
                        </form>
                        <button id="restriction" name="restriction" onclick="restrictionOpen()">
            ...
            <div id="scrollSection2" class="section">
                ...
                <div id="bFooter">
                    ...
                    <p class="footerBoldText">ssib.al v2.0.0-devBuild</p>
                </div>
            </div>
        </div>
    </div>
